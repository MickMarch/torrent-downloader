...
class TestRateLimitBreached:
    ...
    def test_429_response_has_rate_limited_code(self, client: TestClient, mocker: MockerFixture) -> None:
        mocker.patch(
            "torrent_downloader.routers.system.get_disk_usage",
            return_value={"total_gb": 100.0, "used_gb": 50.0, "free_gb": 50.0, "used_percent": 50.0},
        )
    ...
    def test_429_response_has_retry_after_header(self, client: TestClient, mocker: MockerFixture) -> None:
        mocker.patch(
            "torrent_downloader.routers.system.get_disk_usage",
            return_value={"total_gb": 100.0, "used_gb": 50.0, "free_gb": 50.0, "used_percent": 50.0},
        )
...
class TestSearchEndpointLimit:
    def test_breaching_search_limit_returns_429(self, client: TestClient, mocker: MockerFixture) -> None:
        mocker.patch(
