...
class TestAppExceptionHandler:
    def test_returns_correct_status_code(self, client: TestClient, mocker: MockerFixture) -> None:
        mocker.patch(
            ...
            side_effect=AppException(status_code=503, code=ErrorCode.QB_UNAVAILABLE, detail="Unavailable."),
        )
    ...
    def test_response_has_status_field(self, client: TestClient, mocker: MockerFixture) -> None:
        mocker.patch(
            ...
            side_effect=AppException(status_code=404, code=ErrorCode.PATH_NOT_FOUND, detail="Not found."),
        )
...
class TestRouterErrorCodes:
    def test_storage_file_not_found_returns_path_not_found_code(self, client: TestClient, mocker: MockerFixture) -> None:
        mocker.patch(
            "torrent_downloader.routers.system.get_disk_usage",
    ...
    def test_storage_permission_error_returns_permission_denied_code(self, client: TestClient, mocker: MockerFixture) -> None:
        mocker.patch(
            "torrent_downloader.routers.system.get_disk_usage",
